...
const AppIntro = () => {
  return [
    <header key={1} className="header">
      <h1>Loan/Application Register (LAR) Formatting Tool</h1>
      ...
      <p>
        Filers will not need to use the LAR Formatting Tool if they are able to
        format their HMDA data into a pipe delimited text file by using, for
        example, vendor HMDA software, the financial institution’s current Loan
        Origination Software (LOS), or applications such as Microsoft® Access®
        or Excel® that may be used for data entry and formatting.
      </p>
      <p>
