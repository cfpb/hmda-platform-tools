...
const AppIntro = () => {
  return (
    <Header
      ...
      paragraphText="This calculator provides rate spreads for HMDA reportable loans with a
        final action date on or after January 1st, 2018."
    >
      <React.Fragment>
        <p>
        ...
        <p>
          ...
          CFPB market research. The data source for all other products in
          mortgage rate survey data is the Freddie Mac Primary Mortgage Market
          Survey®.
        </p>
        <p>
